...
<head>
    <title>亲亲我的宝贝</title>
    <meta name="keywords" content="亲亲我的宝贝">
    <meta name="description" content="  亲亲我的宝贝 ">
    <meta name="author" content="www.">
    <meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
    <link rel="stylesheet" href="{{URL::asset('/css/reset.css')}}" type="text/css" media="all">
    <link rel="shortcut icon" href="index/images/favicon.ico">
    <link rel="stylesheet" href="{{URL::asset('/css/jquery.fancybox-1.3.4.css')}}" type="text/css" media="screen">
    ...
    <script type="text/javascript" src="{{URL::asset('/js/content_switch.js')}}"></script>
    ...
    <script type="text/javascript" src="{{URL::asset('/js/cScroll.js')}}"></script>
    <script src="{{URL::asset('/js/jquery.cycle.all.latest.js')}}" type="text/javascript"></script>
    <script src="{{URL::asset('/js/jquery.color.js')}}" type="text/javascript"></script>
    ...
    <link rel="stylesheet" href="{{URL::asset('/css/ie.css')}}" type="text/css" media="all">
    <![endif]-->
    <!--[if lt IE 8]>
    ...
    <div class="centre">
        <div class="main">
            ...
            <header>
                ...
                <nav class="menu">
                    <ul id="menu">
                        <li id="nav1"><img src="images/nav1.png" alt=""><span>爱的誓言</span></li>
            ...
            <article id="content">
                <ul>
                    ...
                    <li id="page_About">
                        <img src="images/bg_content.png" alt="" class="bg_cont">
                        <span class="back"><img src="images/nav2.png" alt="" usemap="#back"><a href="javascript:history.go(-1)">返回</a></span>
                        <div class="pad">
                            <h2>恋爱历程</h2>
                            <div class="relative">
                                <div class="scroll">
                    ...
                    <li id="page_Talk">
                        <img src="images/bg_content.png" alt="" class="bg_cont">
                        <span class="back"><img src="images/nav3.png" alt="" usemap="#back"><a href="javascript:history.go(-1)">返回</a></span>
                        <div class="pad">
                            <h2>絮叨絮叨</h2>
                            <div class="relative">
                                <div class="scroll">
                                    <div style="width:100%;float: left; border-bottom: 1px solid #CCCCCC;"><br/><span style="float: right"></span></div>
                    ...
                    <li id="page_Message">
                        <img src="images/bg_content.png" alt="" class="bg_cont">
                        <span class="back"><img src="images/nav4.png" alt="" usemap="#back"><a href="javascript:history.go(-1)">返回</a></span>
                        <div class="pad">
                            <h2>祝福我们</h2>
                            <div class="relative">
                                <div class="scroll">
                    ...
                    <li id="page_Blog">
                        <img src="images/bg_content.png" alt="" class="bg_cont">
                        <span class="back"><img src="images/nav5.png" alt="" usemap="#back"><a href="javascript:history.go(-1)">返回</a></span>
                        <div class="pad">
                            <h2>爱的映像</h2>
                            <div class="relative">
                                <div class="scroll">
                                    <ul class="gallery fancybox">
                                        <li style="line-height:120px"><a href="images/uploadimage/IMG_1273.JPG" rel="prettyPhoto[gallery1]"><img src="images/uploadimage/IMG_1273.JPG" alt=""></a></li>
                                        <li style="line-height:120px"><a href="images/uploadimage/IMG_1275.jpg" rel="prettyPhoto[gallery1]"><img src="images/uploadimage/IMG_1275.jpg" alt=""></a></li>
                                        <li style="line-height:120px"><a href="images/uploadimage/IMG_1747.jpg" rel="prettyPhoto[gallery1]"><img src="images/uploadimage/IMG_1747.jpg" alt=""></a></li>
                                        <li style="line-height:120px"><a href="images/uploadimage/IMG_1748.jpg" rel="prettyPhoto[gallery1]"><img src="images/uploadimage/IMG_1748.jpg" alt=""></a></li>
                                        <li style="line-height:120px"><a href="images/uploadimage/IMG_1749.jpg" rel="prettyPhoto[gallery1]"><img src="images/uploadimage/IMG_1749.jpg" alt=""></a></li>
                                        <li style="line-height:120px"><a href="images/uploadimage/IMG_1750.jpg" rel="prettyPhoto[gallery1]"><img src="images/uploadimage/IMG_1750.jpg" alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <li id="page_Time">
                        <img src="images/bg_content.png" alt="" class="bg_cont">
                        <span class="back"><a href="javascript:history.go(-1)"><img src="images/nav6.png" alt="返回" usemap="#back"></a></span>
                        <div class="pad">
                            <h2>时光沙漏</h2>
